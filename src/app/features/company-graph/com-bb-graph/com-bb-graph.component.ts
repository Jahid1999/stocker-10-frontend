...
addAverageSeries() {
    ...
    chart.options.data.push({
      ...
      markerSize: 0,
      dataPoints: [
        { x: new Date("2021-01-01"), y: [737.708374,  730.367554] },
        { x: new Date("2021-01-02"), y: [730.402649,  774.534973] },
        { x: new Date("2021-01-03"), y: [774.511841, 975.50769] },
        { x: new Date("2021-01-04"), y: [977.058838,1040.233032] },
        { x: new Date("2021-01-05"), y: [1041.498779,  1100.006104] },
        { x: new Date("2021-01-06"), y: [1101.005005,  1207.112183] },
        { x: new Date("2021-01-07"), y: [1208.078369, 1225.678101] },
        { x: new Date("2021-01-08"), y: [1225.967896, 1224.197144] },
        { x: new Date("2021-01-09"), y: [1223.740479,1281.077271] },
        { x: new Date("2021-01-10"), y: [1280.871094,  1262.246704] },
        { x: new Date("2021-01-11"), y: [1261.622925,  1090.145386] },
        { x: new Date("2021-01-12"), y: [1088.526733,  1043.43457] },
        { x: new Date("2021-01-13"), y: [1043.740967,1130.73938] },
        { x: new Date("2021-01-14"), y: [1130.231201,  1218.453003] },
        { x: new Date("2021-01-15"), y: [1221.877197,  1171.834595] },
        { x: new Date("2021-01-16"), y: [1171.443115,  1233.537598] },
        { x: new Date("2021-01-17"), y: [1233.453369,  1230.172241] },
        { x: new Date("2021-01-18"), y: [1230.313232,  1257.279541] },
        { x: new Date("2021-01-19"), y: [1257.43457, 1377.295898] },
        { x: new Date("2021-01-20"), y: [1375.248413,1382.274048] },
        { x: new Date("2021-01-21"), y: [1382.684448,  1121.570923] },
        { x: new Date("2021-01-22"), y: [1118.889038,  1236.512207] },
        { x: new Date("2021-01-23"), y: [1235.267944,  1230.990601] },
        { x: new Date("2021-01-24"), y: [1231.210571,  1391.609375] },
        { x: new Date("2021-01-25"), y: [1390.639893, 1324.414795] },
        { x: new Date("2021-01-26"), y: [1323.741699,  1357.058105] },
        { x: new Date("2021-01-27"), y: [1358.333374, 1253.187134] },
        { x: new Date("2021-01-28"), y: [1251.279785,  1332.492188] },
        { x: new Date("2021-01-29"), y: [1369.086792,  1382.522827] },
        { x: new Date("2021-01-30"), y: [1382.231934, 1376.115479] },
        { x: new Date("2021-01-31"), y: [1376.823608,1314.986206] }
      ]
    });
    chart.render();
  }
